<?php
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<td>" . "<span class=\"quantity-input\"><button class=\"decrement\" id=\"decrement\">-</button>0<button class=\"increment\" id=\"increment\">+</button></span>" . "</td>";
        echo "<td>" . "<span class=\"total\">TOTAL</span>" . "</td>";
        if ($row['availability']){
